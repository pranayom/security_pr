...
def generate_report(
    ...
    lines.append(f"**Tool:** OSS Maintainer Toolkit v0.3.0 (Tiers 1+2)")
    ...
    lines.append(f"")
    lines.append(f"```yaml")
    lines.append(f"- uses: pranayom/oss-maintainer-toolkit@v1")
    lines.append(f"  with:")
    ...
    lines.append(f"")
    lines.append(f"```bash")
    lines.append(f"pip install \"oss-maintainer-toolkit[gatekeeper]\"")
    lines.append(f"```")
    lines.append(f"")
    ...
    lines.append(f"---")
    lines.append(f"")
    lines.append(f"*Generated by [OSS Maintainer Toolkit](https://github.com/pranayom/oss-maintainer-toolkit) v0.3.0 "
